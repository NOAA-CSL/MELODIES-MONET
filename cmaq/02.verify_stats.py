...
from monet.util.stats import NO,NP,NOP,MO,MP,MdnO,MdnP,STDO,STDP,MB,WDMB_m,NMB,WDNMB_m,NMB_ABS,NME_m,NME_m_ABS,WDME_m,RMSE,WDRMSE_m,IOA_m,WDIOA_m,R2 
import pandas as pd
import numpy as np
...
if __name__ == '__main__':
    ...
    for ee in epa_regions:
       ...
       mapping_table = {'OZONE':'O3', 'PM2.5':'PM25', 'PM10':'PM10_new', 'CO':'CO_new', 'NO':'NO_new', 'NO2':'NO2_new', 'SO2':'SO2_new','NOX':'NOX_new','NOY':'NOY_new','TEMP':'TEMP2','WS':'WSPD10','WD':'WDIR10','SRAD':'GSW','BARPR':'PRSFC','PRECIP':'RT','RHUM':'Q2'}
