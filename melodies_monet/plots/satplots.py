...
def make_spatial_overlay(df, vmodel, column_o=None, label_o=None, column_m=None, 
    ...
    #plt.tight_layout(pad=0)
    savefig(outname + '.png',loc=4, height_logo=100, decorate=True, bbox_inches='tight', dpi=150)
    return ax
...
def make_boxplot(comb_bx, label_bx, ylabel = None, vmin = None, vmax = None, outname='plot',
    ...
    plt.tight_layout()
    savefig(outname + '.png',loc=4, height_logo=100, decorate=True, bbox_inches='tight', dpi=200)
